...
export const GuidedTour = ({
  ...
  return <AnimatePresence>
       {isActive && isVisible && <>
        ...
        opacity: 0,
        scale: 0.9
      }} style={getTooltipStyles()} className="w-72 bg-card border border-border rounded-xl shadow-2xl overflow-hidden">
             {/* Header */}
             <div className="gradient-hero-bg px-4 py-3 flex items-center justify-between">
               ...
               <button onClick={handleComplete} className="h-6 w-6 rounded-full bg-primary-foreground/20 flex items-center justify-center text-primary-foreground hover:bg-primary-foreground/30 transition-colors">
                 <X className="h-3 w-3" />
               </button>
             </div>
             ...
             <div className="px-4 pb-4 flex items-center justify-between">
               ...
               <div className="flex gap-2">
                 {currentStep > 0 && <Button size="sm" variant="ghost" onClick={handlePrev}>
...
const TargetHighlight = ({
  ...
  return <motion.div initial={{
    ...
    opacity: 1
  }} className="fixed z-[105] pointer-events-none" style={{
    top: rect.top - 4,
    left: rect.left - 4,
    width: rect.width + 8,
